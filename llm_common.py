...
# annotés manuellement (cf. modif_prompt.txt).
#
...
# v4 = correction de deux défauts de la v3, découverts en annotant manuellement
...
#
# Logique de la grille (RÉVISÉE après annotation manuelle de la zone grise) :
...
# v5 = v2 + trois règles issues de l'annotation manuelle de 101 cas de la zone
