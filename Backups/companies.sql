...
-- Name: companies; Type: TABLE; Schema: public; Owner: REMOVED
--
...
ALTER TABLE public.companies OWNER TO REMOVED;

--
-- TOC entry 222 (class 1259 OID 49619)
-- Name: companies_id_seq; Type: SEQUENCE; Schema: public; Owner: REMOVED
--
...
ALTER SEQUENCE public.companies_id_seq OWNER TO REMOVED;

--
-- TOC entry 3553 (class 0 OID 0)
-- Dependencies: 222
-- Name: companies_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: REMOVED
--
...
-- Name: companies id; Type: DEFAULT; Schema: public; Owner: REMOVED
--
...
-- Dependencies: 220
-- Data for Name: companies; Type: TABLE DATA; Schema: public; Owner: REMOVED
--
...
-- Dependencies: 222
-- Name: companies_id_seq; Type: SEQUENCE SET; Schema: public; Owner: REMOVED
--
...
-- Name: companies companies_isin_key; Type: CONSTRAINT; Schema: public; Owner: REMOVED
--
...
-- Name: companies companies_name_key; Type: CONSTRAINT; Schema: public; Owner: REMOVED
--
...
-- Name: companies companies_pkey; Type: CONSTRAINT; Schema: public; Owner: REMOVED
--
...
-- Name: companies companies_sector_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: REMOVED
--
