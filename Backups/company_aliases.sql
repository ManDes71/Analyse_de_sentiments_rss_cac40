...
-- Name: company_aliases; Type: TABLE; Schema: public; Owner: REMOVED
--
...
ALTER TABLE public.company_aliases OWNER TO REMOVED;

--
-- TOC entry 224 (class 1259 OID 49625)
-- Name: company_aliases_id_seq; Type: SEQUENCE; Schema: public; Owner: REMOVED
--
...
ALTER SEQUENCE public.company_aliases_id_seq OWNER TO REMOVED;

--
-- TOC entry 3554 (class 0 OID 0)
-- Dependencies: 224
-- Name: company_aliases_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: REMOVED
--
...
-- Name: company_aliases id; Type: DEFAULT; Schema: public; Owner: REMOVED
--
...
-- Dependencies: 223
-- Data for Name: company_aliases; Type: TABLE DATA; Schema: public; Owner: REMOVED
--
...
-- Dependencies: 224
-- Name: company_aliases_id_seq; Type: SEQUENCE SET; Schema: public; Owner: REMOVED
--
...
-- Name: company_aliases company_aliases_company_id_alias_key; Type: CONSTRAINT; Schema: public; Owner: REMOVED
--
...
-- Name: company_aliases company_aliases_pkey; Type: CONSTRAINT; Schema: public; Owner: REMOVED
--
...
-- Name: idx_company_aliases_company_id; Type: INDEX; Schema: public; Owner: REMOVED
--
...
-- Name: uq_company_alias_norm; Type: INDEX; Schema: public; Owner: REMOVED
--
...
-- Name: company_aliases trg_company_aliases_norm; Type: TRIGGER; Schema: public; Owner: REMOVED
--
...
-- Name: company_aliases company_aliases_company_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: REMOVED
--
