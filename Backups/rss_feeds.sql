...
-- Name: rss_feeds; Type: TABLE; Schema: public; Owner: manu
--
...
ALTER TABLE public.rss_feeds OWNER TO manu;

--
-- TOC entry 226 (class 1259 OID 49632)
-- Name: rss_feeds_id_seq; Type: SEQUENCE; Schema: public; Owner: manu
--
...
ALTER SEQUENCE public.rss_feeds_id_seq OWNER TO manu;

--
-- TOC entry 3551 (class 0 OID 0)
-- Dependencies: 226
-- Name: rss_feeds_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: manu
--
...
-- Name: rss_feeds id; Type: DEFAULT; Schema: public; Owner: manu
--
...
-- Dependencies: 225
-- Data for Name: rss_feeds; Type: TABLE DATA; Schema: public; Owner: manu
--
...
-- Dependencies: 226
-- Name: rss_feeds_id_seq; Type: SEQUENCE SET; Schema: public; Owner: manu
--
...
-- Name: rss_feeds rss_feeds_pkey; Type: CONSTRAINT; Schema: public; Owner: manu
--
...
-- Name: rss_feeds rss_feeds_url_key; Type: CONSTRAINT; Schema: public; Owner: manu
--
