...
-- Name: sector_aliases; Type: TABLE; Schema: public; Owner: manu
--
...
ALTER TABLE public.sector_aliases OWNER TO manu;

--
-- TOC entry 230 (class 1259 OID 49647)
-- Name: sector_aliases_id_seq; Type: SEQUENCE; Schema: public; Owner: manu
--
...
ALTER SEQUENCE public.sector_aliases_id_seq OWNER TO manu;

--
-- TOC entry 3554 (class 0 OID 0)
-- Dependencies: 230
-- Name: sector_aliases_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: manu
--
...
-- Name: sector_aliases id; Type: DEFAULT; Schema: public; Owner: manu
--
...
-- Dependencies: 229
-- Data for Name: sector_aliases; Type: TABLE DATA; Schema: public; Owner: manu
--
...
-- Dependencies: 230
-- Name: sector_aliases_id_seq; Type: SEQUENCE SET; Schema: public; Owner: manu
--
...
-- Name: sector_aliases sector_aliases_pkey; Type: CONSTRAINT; Schema: public; Owner: manu
--
...
-- Name: sector_aliases sector_aliases_sector_id_alias_uk; Type: CONSTRAINT; Schema: public; Owner: manu
--
...
-- Name: idx_sector_aliases_sector_id; Type: INDEX; Schema: public; Owner: manu
--
...
-- Name: uq_sector_alias_norm; Type: INDEX; Schema: public; Owner: manu
--
...
-- Name: sector_aliases trg_sector_aliases_norm; Type: TRIGGER; Schema: public; Owner: manu
--
...
-- Name: sector_aliases sector_aliases_sector_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: manu
--
