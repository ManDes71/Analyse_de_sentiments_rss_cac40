...
BASELINE = "note_haiku"               # référence principale
REFERENCE_SECONDAIRE = "note_gemini"  # 2e "master", pour isoler la zone grise
...
def filtrer_par_version(df, nom_fichier):
    ...
    if not correspondance:
        ...
        print("  'mark_classification_V4.csv' pour filtrer sur la v4.")
        return df
...
def exporter_zone_grise(zone_grise, chemin="output/zone_grise_haiku_a_annoter.csv", taille=100):
    """
